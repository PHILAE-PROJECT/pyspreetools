...
class SpreeAPIManager:
    def __init__(self, config_file_path=None,config_dict=None):
        ...
        if config_file_path is None and config_dict is None:
            ...
            self.logging = True
            self.log_file = './pyspreetools/logs/log'
            self.test_mode = True
            self.verbose = False
            self.sleep_time = 0.1
    ...
    from ._account import create_an_account, retrieve_an_account
    from ._account_address import create_an_address, remove_an_address, update_an_address, list_all_addresses
    from ._account_orders import list_all_orders, retrieve_an_order
    from ._account_credit_cards import list_all_credit_cards
    from ._auth_token import create_or_refresh_a_token
    from ._cart import create_a_cart, retrieve_a_cart, delete_a_cart
    from ._cart_line_items import add_an_item_to_cart, remove_a_line_item, set_line_item_quantity
    from ._cart_other import associate_a_cart_with_a_user, empty_the_cart
    from ._checkout_shipments import select_shipping_method_for_shipment, list_shipping_rates
    from ._checkout_payments import create_new_payment, list_payment_methods
    from ._checkout_state import next_checkout_step, advance_checkout, complete_checkout
    from ._countries import retrieve_a_country
    from ._checkout import update_checkout
    from ._menus import list_all_menus, retrieve_a_menu
    from ._products import retrieve_a_product, list_all_products
    from ._taxons import list_all_taxons, retrieve_a_taxon
    from ._wishlists import list_all_wishlists, create_a_wish_list, retrieve_a_wishlist, update_a_wishlist, \
        delete_a_wishlist, retrieve_the_default_wishlist
    from ._wishlists_wished_items import add_item_to_wishlist, set_wished_item_quantity, \
        delete_item_from_wishlist
    from ._utils_checkout import guest_checkout, registered_user_checkout
